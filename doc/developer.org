#+TITLE: [[https://github.com/godaddy/Thespian][@@html:<img src="thesplogo2.png" alt="Thespian" width="50%" display="inline" />@@]] Developers Notes
...
#+LATEX_HEADER: \doctype{Developers Notes}
