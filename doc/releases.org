...
#+LATEX_HEADER: \docrev{3.9.0}{2017 Dec 22}
...
*** 3.9.0 <2017-12-22 Fri>
    ...
    * Changes to the Thespian Director:
      ...
      * Added [[file:doc/director.html][documentation for the Thespian Director]], which was
...
*** 3.7.0 <2017-03-19 Sun>
  ...
  * The major enhancement in this release is the
    ...
    See [[http://thespianpy.com/doc/using#actorsystem.private][the description of the private method in the Using Thespian
...
*** 3.2.2 <2016-09-15 Thu>
  ...
  * Documentation updates, including a warning about the inability to
    ...
    conventionally serialized (see [[http://thespianpy.com/doc/using#hH-e23490e4-d720-4e84-9b9a-e768fa3e717d][Source Loading Issues]]).
