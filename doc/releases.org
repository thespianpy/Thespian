...
#+HTML_HEAD: <base href="http://thespianpy.com/releases.html">
...
#+LATEX_HEADER: \docrev{3.7.0}{2017 Mar 19}
...
*** 3.7.0 <2017-03-19 Sun>
  ...
  * The major enhancement in this release is the
    ...
    See [[http://thespianpy.com/using#actorsystem.private][the description of the private method in the Using Thespian
...
*** 3.2.2 <2016-09-15 Thu>
  ...
  * Documentation updates, including a warning about the inability to
    ...
    conventionally serialized (see [[http://thespianpy.com/using#h:e23490e4-d720-4e84-9b9a-e768fa3e717d][Source Loading Issues]]).
