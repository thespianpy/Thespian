...
#+LATEX_HEADER: \docrev{2.4.3}{2015 Nov 18}
...
*** 2.4.3 <2015-11-18 Wed>
  ...
  * Ensure that PoisonMessage sending doesn't recurse.

  * Add missing newline in status output formatting.

  * Add descriptive failure output messaging for IP-based address
