#+TITLE: [[https://github.com/godaddy/Thespian][@@html:<img src="thesplogo2.png" alt="Thespian" width="50%" display="inline" />@@]] In-Depth Introduction
...
#+BEGIN_SRC python -n -r -l "#(ref:%s)" :file hellogoodbye.py
   from thespian.actors import *
...
#+BEGIN_SRC python -n -r -l "#(ref:%s)" :file test-hellogoodbye.py
...
#+CAPTION: hi.py:
#+NAME: hi.py
#+BEGIN_SRC python -n -r -l "#(ref:%s)" :file hi.py
from thespian.actors import *
