...
#+HTML_HEAD: <base href="http://thespianpy.com/in_depth.html">
...
* Background
  :PROPERTIES:
  :CUSTOM_ID: h:2755875e-6956-405e-8be2-cfc2ea596f63
  :END:
...
[[http://thespianpy.com][Thespian library]] itself to share it with the community and allow
others to leverage the Actor Model architecture for Python.

** The Actor Model
   :PROPERTIES:
   :CUSTOM_ID: h:53c50716-fdfa-4b6e-91d0-ed0313de1b4a
   :END:
...
* Thespian Features
  :PROPERTIES:
  :CUSTOM_ID: h:1b595f63-447b-40d1-ad52-582e4ac7a536
  :END:

** Thespian Walk-Through
   :PROPERTIES:
   :CUSTOM_ID: h:0a2f4dce-a031-4631-8270-267fa1956ead
   :END:
...
*** Installation of Thespian
    :PROPERTIES:
    :CUSTOM_ID: h:b974440c-2d2e-4bc0-be71-1f85ca4d397e
    :END:

The Thespian Python library is available on github at
[[http://github.com/kquick/Thespian]], from [[http://pypi.python.org]], or possibly
...
*** Hello World
    :PROPERTIES:
    :CUSTOM_ID: h:2b0d0d3f-4752-4adc-aa3e-db0b46c5739e
    :END:
...
**** Actor System Interaction
     :PROPERTIES:
     :CUSTOM_ID: h:dcc3fb43-fa1f-47df-9eb0-aff3eaa093aa
     :END:
...
** Dynamic Actor Creation
   :PROPERTIES:
   :CUSTOM_ID: h:fc4f8ecb-3a8d-40d9-afbb-2a2a2ff28680
   :END:
...
*** Horizontal Scalability
    :PROPERTIES:
    :CUSTOM_ID: h:015afee7-1483-44d0-bb06-f9d464c842a8
    :END:
...
*** Modularity and Extensibility
    :PROPERTIES:
    :CUSTOM_ID: h:1ff47ec9-6caa-4a8b-8209-2d75c6214728
    :END:
...
** Different ActorSystem Bases
   :PROPERTIES:
   :CUSTOM_ID: h:b2414e9c-4cec-46e7-8d53-80008f2c9498
   :END:
...
*** Base Persistence
    :PROPERTIES:
    :CUSTOM_ID: h:5edfee1e-c49b-40bf-8fa5-970a0d1ee5f5
    :END:
...
**** Code Updates
     :PROPERTIES:
     :CUSTOM_ID: h:7dffe41e-27cd-4b56-bc6a-017add7b2c34
     :END:
...
#+END_EXAMPLE
  ...
  source code as described in [[#h:7b9dbba0-c492-48db-ad43-a94d3e1bef8d][Dynamic Source Loading]].

** Logging
   :PROPERTIES:
   :CUSTOM_ID: h:ff59a149-101e-4e09-8552-81b155d06d72
   :END:
...
*** Source Actor Address Logging
    :PROPERTIES:
    :CUSTOM_ID: h:bb02d15f-a0a3-456f-93df-64ee2712bd89
    :END:
...
** Concurrency
   :PROPERTIES:
   :CUSTOM_ID: h:e01f8b46-7c4d-4740-a2c5-b74380f18875
   :END:
...
*** Debugging
    :PROPERTIES:
    :CUSTOM_ID: h:786634c3-1045-41a3-9354-fe5123fb6508
    :END:
...
** Location Independence
   :PROPERTIES:
   :CUSTOM_ID: h:4d0d08fe-d96a-4937-8bca-2a9b2588bb4c
   :END:
  ...
  *location independence* and means that the Actors operate
  ...
  The combination of location independence and [[#h:015afee7-1483-44d0-bb06-f9d464c842a8][Horizontal Scalability]]
...
*** Capability-based Location Selection
    :PROPERTIES:
    :CUSTOM_ID: h:b6f32db8-fb0e-4110-95c0-c745ab5b730e
    :END:
...
*** Multiple Cooperating Actor Systems
    :PROPERTIES:
    :CUSTOM_ID: h:1ab869b1-c7be-4dce-8346-d4b3a78cb2ba
    :END:
...
** Fault Tolerance
   :PROPERTIES:
   :CUSTOM_ID: h:8835eec5-eb65-4899-ab80-1f861bb5f52c
   :END:
...
* Dynamic Source Loading
  :PROPERTIES:
  :CUSTOM_ID: h:7b9dbba0-c492-48db-ad43-a94d3e1bef8d
  :END:
...
Actors are created.  This can be useful in several ways:
  ...
  * Updating source code running in persistent ActorSystem base
    instances (as described in [[#h:5edfee1e-c49b-40bf-8fa5-970a0d1ee5f5][Base Persistence]]).
...
* Shell
  :PROPERTIES:
  :CUSTOM_ID: h:058d8939-b973-4270-975b-3afd9c607176
  :END:
...
** Starting the Shell
   :PROPERTIES:
   :CUSTOM_ID: h:654845ce-3c0f-4fe8-892a-5ff5d12f5ca0
   :END:
...
** Address Management in the Shell
   :PROPERTIES:
   :CUSTOM_ID: h:092b8ae6-ec6c-4729-9505-8dbd32284d02
   :END:
...
** Shell Test Actor
   :PROPERTIES:
   :CUSTOM_ID: h:c0bca217-9bbe-4d44-b322-a51b86f2ee93
   :END:
...
** Actor Status Requests
   :PROPERTIES:
   :CUSTOM_ID: h:efd0ab30-ef4e-4105-b4b6-4831afc5d3de
   :END:
...
* Conclusion
  :PROPERTIES:
  :CUSTOM_ID: h:2827218b-828e-4d59-9b08-153d46b02134
  :END:
