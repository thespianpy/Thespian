...
more detailed introduction can be found in the [[http://thespianpy.com/doc/in_depth][Thespian In-Depth
Introduction]] document, and [[http://thespian.py/doc/using][Using Thespian]] is the primary API and
