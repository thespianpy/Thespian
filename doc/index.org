#+TITLE: [[http://thespianpy.com][@@html:<img src="thesplogo2.png" alt="Thespian" width="50%" display="inline" />@@]] Python Actors
...
#+LATEX_HEADER: \docrev{1.2}{2015 Sep 18}
...
#+BEGIN_CENTER
@@html:<div class="bannerheader">@@Introducing: Thespian@@html:</div>@@
#+END_CENTER
...
** Thespian Documentation
  ...
  | TXT | PDF | HTML                                                                                                                                |
  |-----+-----+-------------------------------------------------------------------------------------------------------------------------------------|
  | [[file:using.txt][TXT]] | [[file:using.pdf][PDF]] | [[file:using.html][Using Thespian]] is the main documentation reference for developers  writing and implementing Actor-based applications with Thespian. |
  | [[file:developer.txt][TXT]] | [[file:developer.pdf][PDF]] | [[file:developer.html][Thespian Developer's Notes]] provides documentation for developers working on Thespian itself.                                        |
  | [[file:releases.txt][TXT]] | [[file:releases.pdf][PDF]] | Release History is maintained in the [[file:releases.org][Thespian Release Notes]].                                                                        |
  | [[file:in_depth.txt][TXT]] | [[file:in_depth.pdf][PDF]] | An [[file:in_depth.html][In Depth Introduction to Thespian]].                                                                                               |
  |-----+-----+-------------------------------------------------------------------------------------------------------------------------------------|
