...
#+HTML_HEAD: <base href="http://thespianpy.com/using.html">
...
#+LATEX_HEADER: \docrev{2.15}{2017 Mar 19}
...
* Actor Overview
  :PROPERTIES:
  :CUSTOM_ID: h:f23d674d-ce24-48b4-8ad8-be8eb299e89e
  :END:

** Actors
   :PROPERTIES:
   :CUSTOM_ID: h:2889c112-6505-4b32-9dce-ac3e4a16ad11
   :END:
...
** Actor Addresses
   :PROPERTIES:
   :CUSTOM_ID: h:1348ab18-1a45-495b-ad27-84810a0b42f4
   :END:
...
** ActorSystem
   :PROPERTIES:
   :CUSTOM_ID: h:4adf735c-f237-4a8e-98db-ec52567353ac
   :END:
...
*** Different Implementations
    :PROPERTIES:
    :CUSTOM_ID: h:27f1994d-f66e-4be7-a671-8eeeb81bbd4b
    :END:
  ...
  as described previously in [[#h:1348ab18-1a45-495b-ad27-84810a0b42f4][Actor Addresses]] the Actors themselves
  ...
  The [[#h:2a5fa63d-e6eb-43b9-bea8-47223b27544e][ActorSystem Implementations]] section provides detailed
  information about the known ActorSystem implementations including
  their level of feature support and any known issues.

*** Multiple Systems
    :PROPERTIES:
    :CUSTOM_ID: h:461f4dc3-4bd6-46fe-a33e-2ad2a8d82d53
    :END:
...
** External Communications
   :PROPERTIES:
   :CUSTOM_ID: h:c183ae4b-b397-433f-aa4e-69a6838ece38
   :END:
...
ActorSystem itself:
   ...
   * *createActor* -- creates a new Actor.  There is no [[#h:3868571d-e754-42a2-840e-6629e817903b][Parent Actor]]
...
[[#h:7d2b4986-95d3-4460-9d19-ea0dcdb34fca][ActorSystem API]] section.

** Effects
   :PROPERTIES:
   :CUSTOM_ID: h:f9386620-2d2e-4f28-b971-0f106881f583
   :END:
...
** Comparisons
   :PROPERTIES:
   :CUSTOM_ID: h:4f420b34-24a5-49a0-b70b-e34a925e7c17
   :END:

*** Message Bus (Pub/Sub) Architecture
    :PROPERTIES:
    :CUSTOM_ID: h:357ddb80-542c-47d6-aa68-1964639777e9
    :END:
...
*** Logging Systems
    :PROPERTIES:
    :CUSTOM_ID: h:aeed6732-198c-41a6-8d2b-45c3b57a120f
    :END:
...
As noted in the [[#h:357ddb80-542c-47d6-aa68-1964639777e9][Message Bus (Pub/Sub) Architecture]], the Actor model is
...
* Using Thespian
  :PROPERTIES:
  :CUSTOM_ID: h:bfd7e2ce-64cc-4267-85ce-091a3fd29a8b
  :END:
...
** Starting an Actor System
   :PROPERTIES:
   :CUSTOM_ID: h:0c5d14ea-e462-4a9c-b078-58341cc70e6d
   :END:
...
[[#h:f71b7bfa-c57b-4716-a2c7-ad83a2ed3582][ActorSystem]], and the known system bases are describe in [[#h:2a5fa63d-e6eb-43b9-bea8-47223b27544e][ActorSystem Implementations]].
...
** Actor Lifecycle
   :PROPERTIES:
   :CUSTOM_ID: h:41cd5450-c34f-4672-aafa-c96ed29c3f01
   :END:
...
*** Creating a Top-Level Actor
    :PROPERTIES:
    :CUSTOM_ID: h:df9e99d0-dac0-4cbb-8852-6a3bb95c68f9
    :END:
...
Actor making the request becomes the "[[#h:3868571d-e754-42a2-840e-6629e817903b][Parent Actor]]" of the newly
...
A Top-Level Actor is created via the [[#h:a565af1b-aabb-4336-a51d-7505c072c319][ActorSystem.createActor]] call:
...
ActorSystem's [[#h:8e52624b-cda1-4218-bc9f-693cf06b0758][ask]]() or [[#h:a5dcf9d2-7bda-43c7-ab44-86265992e972][tell]]() methods to communicate with the created
Actor.

*** Creating an Actor
    :PROPERTIES:
    :CUSTOM_ID: h:de8ad884-0d69-4734-abf5-eb3f1e4a8723
    :END:

Within the ActorSystem, and Actor can create another Actor by making
the request to the ActorSystem through the [[#h:3663d87d-8a2f-485b-aeef-c6e9cf418b4c][createActor]]() method on its
own instance:
...
created Actor (using the current Actor's [[#h:28cb6d46-fa93-4efd-bc83-88bbbd50df66][send]]() method).

*** Killing an Actor
    :PROPERTIES:
    :CUSTOM_ID: h:e1d97e35-1d26-4277-b06b-239b6ab4d5d3
    :END:
...
[[#h:7e6106e4-a631-47a4-9d22-3fd63f7e1951][ActorExitRequest]] message.
...
described in [[#h:5af075c1-73b1-4f7c-8515-e55ed96c03a9][Dead Letter Handling]].


*** Parent Actor
    :PROPERTIES:
    :CUSTOM_ID: h:3868571d-e754-42a2-840e-6629e817903b
    :END:

    An Actor which creates other Actors automatically becomes the
    "Parent" of the created Actor(s).  In the example in the [[#h:de8ad884-0d69-4734-abf5-eb3f1e4a8723][Creating
...
*** Actor Failure
    :PROPERTIES:
    :CUSTOM_ID: h:fb0eba5e-9d12-4cfe-8e8c-fe77b6658065
    :END:
   ...
   message.  See [[#h:62e20202-9bff-4455-968e-73fee0b9f66a][PoisonMessage Returns]] for more details.

* Guidelines for Actors and their messages
  :PROPERTIES:
  :CUSTOM_ID: h:bb3655d6-66df-42d5-9486-e81c8687e9d6
  :END:
  ...
  - All messages sent by the ActorSystem to an Actor are derived from
    ...
    ActorSystem can deliver to an Actor are:
       ...
       + ActorExitRequest   (see [[#h:e1d97e35-1d26-4277-b06b-239b6ab4d5d3][Killing an Actor]])
       + ChildActorExited   (see [[#h:3868571d-e754-42a2-840e-6629e817903b][Parent Actor]])
       + PoisonMessage      (see [[#h:62e20202-9bff-4455-968e-73fee0b9f66a][PoisonMessage Returns]])
       + ActorSystemConventionUpdate  (see [[#h:3c8aa454-9a21-4d24-a623-ad86bfd4f5a7][Other Actor Systems]])
       + WakeupMessage      (see [[#h:9cc1acd4-7f35-44ac-94fc-0326dc87a7a5][Timer Messages]])
  ...
  - It is a common practice to have an Actor probe for functional
    ...
    [[#h:1dc4362f-78dd-4adf-833c-d7bebda07ef8][updateCapability]]).  Changing the existing capabilities *may*
...
* Thespian Actor Feature Extensions
  :PROPERTIES:
  :CUSTOM_ID: h:330e09d9-4a98-4814-8a1c-6003ce6a7995
  :END:
...
** Message Delivery
   :PROPERTIES:
   :CUSTOM_ID: h:3d280f21-4a99-416f-8cd7-9c9380a1c86c
   :END:
  ...
  is redirected as described in [[#h:5af075c1-73b1-4f7c-8515-e55ed96c03a9][Dead Letter Handling]].

*** Message Mutability
    :PROPERTIES:
    :CUSTOM_ID: h:23ac66d7-ba55-40dc-ade8-a71e51c7a404
    :END:
...
#+END_SRC
  ...
  but the [[#h:924dc0fe-c15b-491e-a6d1-8b88683d4c0d][simpleSystemBase]] (for example) is exposed to this modification.
...
** Dead Letter Handling
   :PROPERTIES:
   :CUSTOM_ID: h:5af075c1-73b1-4f7c-8515-e55ed96c03a9
   :END:
  ...
  handling.  The routed message will be wrapped in a [[#h:e3d4bfa0-7fad-4622-b707-8f67e4f75d5c][DeadEnvelope]]
...
** Non-startable Actors
   :PROPERTIES:
   :CUSTOM_ID: h:badcba33-bc39-4009-833f-07617ec72e12
   :END:
  ...
  (see [[#h:5af075c1-73b1-4f7c-8515-e55ed96c03a9][Dead Letter Handling]]) then it can perform special actions to
...
** PoisonMessage Returns
   :PROPERTIES:
   :CUSTOM_ID: h:62e20202-9bff-4455-968e-73fee0b9f66a
   :END:
   ...
   [[#h:fb0eba5e-9d12-4cfe-8e8c-fe77b6658065][Actor Failure]]).
   ...
   See [[#h:407c4c79-2a05-442d-b6e8-5bf7c2f2d068][PoisonMessage]] for details on the ~PoisonMessage~ object.

** Top-Level Actors
   :PROPERTIES:
   :CUSTOM_ID: h:91e3dc4e-af22-4076-94ee-43f60458f0e0
   :END:
  ...
  [[#h:3868571d-e754-42a2-840e-6629e817903b][Parent Actor]]).  Since there is no Parent Actor, there is nowhere to
  ...
  redirected to the Dead Letter Handler (see [[#h:5af075c1-73b1-4f7c-8515-e55ed96c03a9][Dead Letter Handling]]).

** Named Actors
   :PROPERTIES:
   :CUSTOM_ID: h:2d5ef9c7-2132-45f9-b6eb-6f2729f5b232
   :END:
  ...
  ~globalName~ parameter to the ActorSystem's [[#h:a565af1b-aabb-4336-a51d-7505c072c319][createActor]] call or the
  Actor's [[#h:3663d87d-8a2f-485b-aeef-c6e9cf418b4c][createActor]] call).
  ...
  considered relative to their convenience:
   ...
   1. All Named Actors are similar to [[#h:91e3dc4e-af22-4076-94ee-43f60458f0e0][Top-Level Actors]] in that they
...
** Timer Messages
   :PROPERTIES:
   :CUSTOM_ID: h:9cc1acd4-7f35-44ac-94fc-0326dc87a7a5
   :END:
  ...
  be queued causing eventual delivery failure (see [[#h:3d280f21-4a99-416f-8cd7-9c9380a1c86c][Message Delivery]]).
...
** Watching File Descriptors
   :PROPERTIES:
   :CUSTOM_ID: h:94edef18-154e-4847-864f-027dff4f6e0a
   :END:
...
*** Blocking Actors
    :PROPERTIES:
    :CUSTOM_ID: h:df96b2ed-e292-4ded-a614-30cfa1557858
    :END:
  ...
  backpressure builds (see [[#h:3d280f21-4a99-416f-8cd7-9c9380a1c86c][Message Delivery]] for more details).
...
** Actor Troupes
   :PROPERTIES:
   :CUSTOM_ID: h:19cf92bf-a6ae-492c-844c-b0831c108a3a
   :END:
   ...
   * A message will be delivered to only one member of the Troupe, but
   ...
   See [[#h:c796bc0d-a150-4fb9-8918-58f470813175][Actor Troupe Support]] for more details.

** ActorSystem Capabilities
   :PROPERTIES:
   :CUSTOM_ID: h:a17e6c70-5592-4d06-b818-bd25350c4c53
   :END:
  ...
  common capabilities described in the [[#h:2a4bcad4-9fe0-4399-86d4-4bbf0ba0acb7][Common Capabilities]] section.

** Other Actor Systems
   :PROPERTIES:
   :CUSTOM_ID: h:3c8aa454-9a21-4d24-a623-ad86bfd4f5a7
   :END:

  The current ActorSystem can communicate with other ActorSystems to
  coordinate Actor activities as described in [[#h:461f4dc3-4bd6-46fe-a33e-2ad2a8d82d53][Multiple Systems]].  To
  support this, the ActorSystems communicate on known transport
  addresses to form a "Convention" of ActorSystems.

  When new Actors are created, the [[#h:a17e6c70-5592-4d06-b818-bd25350c4c53][ActorSystem Capabilities]] of the
  ...
  [[#h:f311fc02-d355-4d68-b9af-958404637e57][ActorSystemConventionUpdate]] message for these events.  Actors
  register for these updates using the
  [[#h:b9f7a2f0-7d2a-4cc0-8241-1fee7c62c44e][notifyOnSystemRegistrationChanges]] API call.
...
*** Convention Establishment
    :PROPERTIES:
    :CUSTOM_ID: h:bd57f29e-4a5e-4725-9ced-7e0c5fa5bcbd
    :END:
  ...
  2. The Convention Leader is told about members and actively attempts
     ...
     using the [[#h:956e30d5-c035-4e1e-86cb-73332e28d8d4][preRegisterRemoteSystem()]] call.  In this mode, the
     Convention Leader will actively connect to the remote to
     establish or re-establish connectivity (until the membership is
     cancelled, for example, with the [[#h:ce801678-bcff-497d-be2a-439cb34fc519][deRegisterRemoteSystem()]] call).

     This latter method is particularly suited to configurations using
     the "Outbound Only" connectivity mode (see [[#h:9d33a877-b4f0-4012-9510-442d81b0837c][multiprocTCPBase]] for
...
*** Convention Administrator Communications
    :PROPERTIES:
    :CUSTOM_ID: h:0500ead3-28ea-440c-9ad6-56cb9fbdd648
    :END:
...
** Performance
   :PROPERTIES:
   :CUSTOM_ID: h:5e670e59-8334-477e-a9d2-0c2dc39d82dd
   :END:
...
** Logging
   :PROPERTIES:
   :CUSTOM_ID: h:ce55494c-dd7a-4258-a1e8-b090c3bbb1e6
   :END:
...
explicitly indicated in the [[#h:2a5fa63d-e6eb-43b9-bea8-47223b27544e][ActorSystem Implementations]] section).
...
*** Thespian Internals Logging
    :PROPERTIES:
    :CUSTOM_ID: h:856a7ffe-676b-42a9-95eb-bd89a5810f53
    :END:
...
** Actor Code Distribution
   :PROPERTIES:
   :CUSTOM_ID: h:955ec990-a267-4d08-8f4d-5f980c777173
   :END:
  ...
  The [[#h:731cff6e-674d-4341-bd92-80a08113d5df][loadActorSource]] operation describes this capability in more
  detail, including security protections associated with this feature.

* Actor API
  :PROPERTIES:
  :CUSTOM_ID: h:c3ba9430-5229-44ad-bbd5-ff5426e03e5e
  :END:
...
#+end_src
  ...
  [[#h:a17e6c70-5592-4d06-b818-bd25350c4c53][ActorSystem Capabilities]].

** myAddress
   :PROPERTIES:
   :CUSTOM_ID: h:584dd408-9496-4f6f-8a86-0f0236f73893
   :END:
...
** receiveMessage
   :PROPERTIES:
   :CUSTOM_ID: h:f89540de-f853-42e3-9d52-23b1f84a251e
   :END:
...
#+end_src
   ...
   the Actor (or [[#h:c183ae4b-b397-433f-aa4e-69a6838ece38][External Communications]] endpoint) sending the
   message.

   The message can be discarded once it has been handled.  As
   described previously in [[#h:2889c112-6505-4b32-9dce-ac3e4a16ad11][Actors]], there are three things an Actor can
   ...
   returned to the sender as described in [[#h:62e20202-9bff-4455-968e-73fee0b9f66a][PoisonMessage Returns]].  Note
...
*** Return Value
    :PROPERTIES:
    :CUSTOM_ID: h:c7c7275c-fa32-4466-9d1a-e888f993e67c
    :END:
   ...
   supports the Thespian Watch extension (see [[#h:94edef18-154e-4847-864f-027dff4f6e0a][Watching File
   ...
   [[#h:8a46cfae-7ccc-407a-91c1-d4301b7a653c][WatchMessage]] with the file number(s) for which data is available.
...
** createActor
   :PROPERTIES:
   :CUSTOM_ID: h:3663d87d-8a2f-485b-aeef-c6e9cf418b4c
   :END:
...
#+end_src
   ...
   will be passed passed to the [[#h:0e9f4a6a-3083-40fa-a75b-ced37d70eef0][actorSystemCapabilityCheck]] to use for
   validating whether the Actor can be started within the current
   ActorSystem environment (see [[#h:a17e6c70-5592-4d06-b818-bd25350c4c53][ActorSystem Capabilities]]).  The value
   ...
   describe in [[#h:2d5ef9c7-2132-45f9-b6eb-6f2729f5b232][Named Actors]], this name allows the Actor to be a
   ...
   the current Actor, relative to any [[#h:731cff6e-674d-4341-bd92-80a08113d5df][loadActorSource]] operation that
   ...
   will be handled as described in the [[#h:5af075c1-73b1-4f7c-8515-e55ed96c03a9][Dead Letter Handling]] section.


*** globalName
    :PROPERTIES:
    :CUSTOM_ID: h:c5ae8d61-9358-463d-b0f0-d15ae0246059
    :END:
  ...
  exit; there is no [[#h:ed408390-5a74-4955-9f7d-a84e87595459][ChildActorExited]] notification sent to any Actors
  that requested the creation of the Named Actor.

*** Actor Creation Gotchas
    :PROPERTIES:
    :CUSTOM_ID: h:57dd8b71-0f60-4ad2-9628-08edf2c5b00c
    :END:
  ...
  1. Actor classes must either have been in the system path when the
     ...
     Source (see [[#h:731cff6e-674d-4341-bd92-80a08113d5df][loadActorSource]]).  Many ActorSystems use separate
...
** send
   :PROPERTIES:
   :CUSTOM_ID: h:28cb6d46-fa93-4efd-bc83-88bbbd50df66
   :END:
...
#+end_src
    ...
    sending the message to [[#h:5af075c1-73b1-4f7c-8515-e55ed96c03a9][Dead Letter Handling]] if it cannot be
    delivered.

** wakeupAfter
   :PROPERTIES:
   :CUSTOM_ID: h:b2b4b63a-c256-4793-8591-1ce8dbd87131
   :END:
...
#+end_src
    ...
    entrypoint (the sender will be the Actor itself).  See [[#h:9cc1acd4-7f35-44ac-94fc-0326dc87a7a5][Timer
    Messages]] for more information.

** handleDeadLetters
   :PROPERTIES:
   :CUSTOM_ID: h:4022d522-cdc6-487a-b5d5-5d992572c531
   :END:
...
** notifyOnSystemRegistrationChanges
   :PROPERTIES:
   :CUSTOM_ID: h:b9f7a2f0-7d2a-4cc0-8241-1fee7c62c44e
   :END:
...
#+end_src
  ...
  [[#h:3c8aa454-9a21-4d24-a623-ad86bfd4f5a7][Other Actor Systems]]) via [[#h:f311fc02-d355-4d68-b9af-958404637e57][ActorSystemConventionUpdate]] messages.

** registerSourceAuthority
   :PROPERTIES:
   :CUSTOM_ID: h:5ae05479-5a6d-4f01-bd7d-c4f544f7b98a
   :END:
...
#+end_src
   ...
   handler for the current ActorSystem as described in the [[#h:b26e4f60-d3fa-40b1-bc33-bb20b61ff2d4][Security Considerations]] section of the [[#h:731cff6e-674d-4341-bd92-80a08113d5df][loadActorSource]] ActorSystem API
   call.  Once registered, this Actor will receive [[#h:3119580d-80a6-4061-a217-1b2b21014172][ValidateSource]]
...
** loadActorSource
   :PROPERTIES:
   :CUSTOM_ID: h:731cff6e-674d-4341-bd92-80a08113d5df
   :END:
...
#+end_src
  ...
  zipfile that can be used in subsequent [[#h:3663d87d-8a2f-485b-aeef-c6e9cf418b4c][createActor]] calls to
  instantiate Actors found in that sourcefile.

  There must be a valid Source Authority registered (via the
  [[#h:5ae05479-5a6d-4f01-bd7d-c4f544f7b98a][registerSourceAuthority]] method) to validate the loaded source; by
  default this method does nothing if no Source Authority has been
  loaded.  See [[#h:b26e4f60-d3fa-40b1-bc33-bb20b61ff2d4][Security Considerations]] for more information.

  See the description of the same function in the [[#h:7d2b4986-95d3-4460-9d19-ea0dcdb34fca][ActorSystem API]]
  section for more details.

** unloadActorSource
   :PROPERTIES:
   :CUSTOM_ID: h:02eaa317-996a-419b-b9e5-462a28a749c0
   :END:
...
#+end_src
  ...
  previously loaded by the [[#h:731cff6e-674d-4341-bd92-80a08113d5df][loadActorSource]] operation.
...
** notifyOnSourceAvailability
   :PROPERTIES:
   :CUSTOM_ID: h:460d04d8-3961-43c4-a4c3-8282c2e4a892
   :END:
...
#+end_src
  ...
  [[#h:7cc41555-6b60-4844-8cea-0ec3714cf8f8][LoadedSource]] message and source unloads generate [[#h:2a5fa63d-e6eb-43b9-bea8-47223b27544e][UnloadedSource]]
...
** actorSystemCapabilityCheck
   :PROPERTIES:
   :CUSTOM_ID: h:0e9f4a6a-3083-40fa-a75b-ced37d70eef0
   :END:
...
#+end_src
  ...
  capabilities (see [[#h:a17e6c70-5592-4d06-b818-bd25350c4c53][ActorSystem Capabilities]]).
  ...
  described in the [[#h:1dc4362f-78dd-4adf-833c-d7bebda07ef8][updateCapability]] section), and if it returns False
  then the existing Actor will be killed with an [[#h:7e6106e4-a631-47a4-9d22-3fd63f7e1951][ActorExitRequest]]
  message.

*** requireCapability decorator
    :PROPERTIES:
    :CUSTOM_ID: h:3bafc1e2-9e3d-4073-8e75-c01ad792b5be
    :END:
...
** updateCapability
   :PROPERTIES:
   :CUSTOM_ID: h:1dc4362f-78dd-4adf-833c-d7bebda07ef8
   :END:
   ...
   updates; see the [[#h:7d2b4986-95d3-4460-9d19-ea0dcdb34fca][ActorSystem API]] for that version).
...
#+end_src
   ...
   their [[#h:0e9f4a6a-3083-40fa-a75b-ced37d70eef0][actorSystemCapabilityCheck]] static method and sending them an
   ...
   issuing a [[#h:6428fa90-8749-4777-a0b1-752ec5eb1650][Thespian_StatusReq]] to the ActorSystem.

** preRegisterRemoteSystem
   :PROPERTIES:
   :CUSTOM_ID: h:956e30d5-c035-4e1e-86cb-73332e28d8d4
   :END:
   ...
   that support Conventions (as describe in the [[#h:3c8aa454-9a21-4d24-a623-ad86bfd4f5a7][Other Actor Systems]]
   section).
...
** deRegisterRemoteSystem
   :PROPERTIES:
   :CUSTOM_ID: h:ce801678-bcff-497d-be2a-439cb34fc519
   :END:
...
#+end_src
   ...
   [[#h:f311fc02-d355-4d68-b9af-958404637e57][ActorSystemConventionUpdate]] messages).

** actorSystemShutdown
   :PROPERTIES:
   :CUSTOM_ID: h:9e800ed1-ed40-4ff3-8445-f795719f6218
   :END:
...
** ActorTypeDispatcher
   :PROPERTIES:
   :CUSTOM_ID: h:2f5b52bd-72b8-41eb-b879-809d174c0e30
   :END:
...
*** Type Handling Deferral
    :PROPERTIES:
    :CUSTOM_ID: h:e58ce3a1-df40-4d3f-bc1f-e7743e3c1dc1
    :END:
...
* ActorSystem API
  :PROPERTIES:
  :CUSTOM_ID: h:7d2b4986-95d3-4460-9d19-ea0dcdb34fca
  :END:
...
** Exceptions
   :PROPERTIES:
   :CUSTOM_ID: h:a91e6169-660d-4df0-af13-15b3ad5e63bc
   :END:
...
** ActorSystem
   :PROPERTIES:
   :CUSTOM_ID: h:f71b7bfa-c57b-4716-a2c7-ad83a2ed3582
   :END:
...
#+end_src
    ...
    selected from those systems describe in the [[#h:2a5fa63d-e6eb-43b9-bea8-47223b27544e][ActorSystem Implementations]] section. If ~systemBase~ is None, this call will
    ...
    base is the ~simpleSystemBase~ (see [[#h:924dc0fe-c15b-491e-a6d1-8b88683d4c0d][simpleSystemBase]]).

    The ~capabilities~ argument should be a dictionary of capability
    keys and values as describe in the [[#h:a17e6c70-5592-4d06-b818-bd25350c4c53][ActorSystem Capabilities]]
    ...
    described in the [[#h:ce55494c-dd7a-4258-a1e8-b090c3bbb1e6][Logging]] section, the Convention Leader will
...
** ActorSystem.shutdown
   :PROPERTIES:
   :CUSTOM_ID: h:654a6c81-b326-4c0a-98bc-638ac5ce631f
   :END:
...
#+END_SRC
    ...
    system base used (see [[#h:2a5fa63d-e6eb-43b9-bea8-47223b27544e][ActorSystem Implementations]] for details).
...
** ActorSystem.createActor
   :PROPERTIES:
   :CUSTOM_ID: h:a565af1b-aabb-4336-a51d-7505c072c319
   :END:
...
#+end_src
   ...
   This call is very similar to the [[#h:3663d87d-8a2f-485b-aeef-c6e9cf418b4c][createActor]] Actor API call except
   ...
   passed to the [[#h:0e9f4a6a-3083-40fa-a75b-ced37d70eef0][actorSystemCapabilityCheck]] to use for validating
   whether the Actor can be started within the current ActorSystem
   environment (see [[#h:a17e6c70-5592-4d06-b818-bd25350c4c53][ActorSystem Capabilities]]).  The value specified
   ...
   load the ~actorClass~ source and start the Actor.
     * The source file must previously have been loaded by the
       [[#h:73b564d2-faa3-4fc8-bfdf-5362626c03be][loadActorSource]] operation.
...
** tell
   :PROPERTIES:
   :CUSTOM_ID: h:a5dcf9d2-7bda-43c7-ab44-86265992e972
   :END:
...
** ask
   :PROPERTIES:
   :CUSTOM_ID: h:8e52624b-cda1-4218-bc9f-693cf06b0758
   :END:
...
*** Gotchas
    :PROPERTIES:
    :CUSTOM_ID: h:b660216f-003b-4041-93cb-566be7edf72c
    :END:
...
** listen
   :PROPERTIES:
   :CUSTOM_ID: h:c68f8ef8-94e9-46d6-8e67-634d04c16562
   :END:
...
** updateCapability
   :PROPERTIES:
   :CUSTOM_ID: h:bf228654-b542-48f0-a5b5-78bc883528b9
   :END:
...
** loadActorSource
   :PROPERTIES:
   :CUSTOM_ID: h:73b564d2-faa3-4fc8-bfdf-5362626c03be
   :END:
...
#+end_src
  ...
  zipimport format (via PEP302[fn:PEP302] methodologies).  The return value
  is an internally-generated hash value identifying that loaded source
  zipfile that can be used in subsequent [[#h:0e9f4a6a-3083-40fa-a75b-ced37d70eef0][createActor]] calls to
  instantiate Actors found in that sourcefile.
...
[fn:PEP302] The PEP302 Python extension specification defines the
  ...
  [[#h:b26e4f60-d3fa-40b1-bc33-bb20b61ff2d4][Security Considerations]] section below; when an encrypted zipfile is
...
*** Source Loading Issues
    :PROPERTIES:
    :CUSTOM_ID: h:e23490e4-d720-4e84-9b9a-e768fa3e717d
    :END:
...
*** Security Considerations
    :PROPERTIES:
    :CUSTOM_ID: h:b26e4f60-d3fa-40b1-bc33-bb20b61ff2d4
    :END:
...
**** Multi-System Source Authorization
     :PROPERTIES:
     :CUSTOM_ID: h:059157fd-4272-4d2e-a1c8-aa0069e5b1f5
     :END:

  The Source Authority registration is unique to an ActorSystem.
  Different ActorSystems in a [[#h:461f4dc3-4bd6-46fe-a33e-2ad2a8d82d53][Multiple Systems]] configuration can each
  have a separate Source Authority that may perform different
  authorization techniques.  However, as described in [[#h:955ec990-a267-4d08-8f4d-5f980c777173][Actor Code
  ...
  capability setting in the [[#h:2a4bcad4-9fe0-4399-86d4-4bbf0ba0acb7][Common Capabilities]] section).
...
** unloadActorSource
   :PROPERTIES:
   :CUSTOM_ID: h:3e2f292f-2797-46d7-9fc6-48c1619d4bec
   :END:
...
* ActorSystem Messages
  :PROPERTIES:
  :CUSTOM_ID: h:b889aca8-b50d-4920-8496-34b1420cf664
  :END:
...
** PoisonMessage
   :PROPERTIES:
   :CUSTOM_ID: h:407c4c79-2a05-442d-b6e8-5bf7c2f2d068
   :END:
   ...
   cleanup or alternative work based on the target Actor failure (see [[#h:62e20202-9bff-4455-968e-73fee0b9f66a][PoisonMessage Returns]]).

*** Attributes
    :PROPERTIES:
    :CUSTOM_ID: h:7655532a-ec5a-49c0-9f4e-0b4207f21080
    :END:
...
** WakeupMessage
   :PROPERTIES:
   :CUSTOM_ID: h:32b3df34-552e-4398-83bb-b78f3f6483bc
   :END:
  ...
  call (see [[#h:9cc1acd4-7f35-44ac-94fc-0326dc87a7a5][Timer Messages]]).

*** Attributes
    :PROPERTIES:
    :CUSTOM_ID: h:865814f4-6d08-4657-bb89-c3be8b8a9453
    :END:
...
** WatchMessage
   :PROPERTIES:
   :CUSTOM_ID: h:8a46cfae-7ccc-407a-91c1-d4301b7a653c
   :END:
  ...
  implementations.  See [[#h:94edef18-154e-4847-864f-027dff4f6e0a][Watching File Descriptors]] for more
  information.

*** Attributes
    :PROPERTIES:
    :CUSTOM_ID: h:a4719aee-2054-466c-a013-03b6938b084e
    :END:
...
** ActorExitRequest
   :PROPERTIES:
   :CUSTOM_ID: h:7e6106e4-a631-47a4-9d22-3fd63f7e1951
   :END:
...
*** Attributes
    :PROPERTIES:
    :CUSTOM_ID: h:8155fe0d-ad17-4677-b606-f830c6f9f249
    :END:
...
** ChildActorExited
   :PROPERTIES:
   :CUSTOM_ID: h:ed408390-5a74-4955-9f7d-a84e87595459
   :END:
   ...
   of whether the exit was due to the receipt of an [[#h:7e6106e4-a631-47a4-9d22-3fd63f7e1951][ActorExitRequest]]
   message or if the Actor was killed by other means.

   The Parent of [[#h:2d5ef9c7-2132-45f9-b6eb-6f2729f5b232][Named Actors]] is the ActorSystem itself; no
...
*** Attributes
    :PROPERTIES:
    :CUSTOM_ID: h:c32348b6-fed3-4ff1-bf95-3cf491049518
    :END:
...
** DeadEnvelope
   :PROPERTIES:
   :CUSTOM_ID: h:e3d4bfa0-7fad-4622-b707-8f67e4f75d5c
   :END:

   The ~DeadEnvelope~ object is delivered to the Dead Letter handler as
   described in [[#h:5af075c1-73b1-4f7c-8515-e55ed96c03a9][Dead Letter Handling]].  The ~DeadEnvelope~ is a wrapper
   around the original message that could not be delivered to the
   target Actor because the target is no longer running.

*** Attributes
    :PROPERTIES:
    :CUSTOM_ID: h:fc0fb45a-a981-42ce-9922-705dabbbda37
    :END:
...
** ActorSystemConventionUpdate
   :PROPERTIES:
   :CUSTOM_ID: h:f311fc02-d355-4d68-b9af-958404637e57
   :END:
   ...
   convention membership (as described in [[#h:955ec990-a267-4d08-8f4d-5f980c777173][Other Actor Systems]]).  This
   message is generated by the ActorSystem itself.

*** Attributes
    :PROPERTIES:
    :CUSTOM_ID: h:a1cda86c-ca86-4aaa-bcb5-935e92435647
    :END:
...
** ValidateSource
   :PROPERTIES:
   :CUSTOM_ID: h:3119580d-80a6-4061-a217-1b2b21014172
   :END:
   ...
   [[#h:731cff6e-674d-4341-bd92-80a08113d5df][loadActorSource]] call to the ActorSystem.  The Actor receiving this
   ...
   [[#h:1db8e94e-ca54-4817-b120-b4c51c680cdd][ValidatedSource]] message specifying None as the validated source.
   ...
   load via the [[#h:6428fa90-8749-4777-a0b1-752ec5eb1650][Thespian_StatusReq]] operation.

*** Attributes
    :PROPERTIES:
    :CUSTOM_ID: h:d6db3148-7664-4e50-9061-6733fe5d3a3f
    :END:

  * ~.sourceHash~ -- the hash associated with this loaded source.
  * ~.sourceData~ -- the input data (file contents) provided to the
    [[#h:731cff6e-674d-4341-bd92-80a08113d5df][loadActorSource]] call to the ActorSystem.

** ValidatedSource
   :PROPERTIES:
   :CUSTOM_ID: h:1db8e94e-ca54-4817-b120-b4c51c680cdd
   :END:
   ...
   the response to a [[#h:3119580d-80a6-4061-a217-1b2b21014172][ValidateSource]] message.  The data associated with
...
*** Attributes
    :PROPERTIES:
    :CUSTOM_ID: h:92e91efa-fdc2-42bb-94f8-8a329618214c
    :END:
...
** LoadedSource
   :PROPERTIES:
   :CUSTOM_ID: h:7cc41555-6b60-4844-8cea-0ec3714cf8f8
   :END:
   ...
   This message is delivered to each [[#h:460d04d8-3961-43c4-a4c3-8282c2e4a892][notifyOnSourceAvailability]]
...
*** Attributes
    :PROPERTIES:
    :CUSTOM_ID: h:54e4613a-3c85-4d1e-a81d-0dd348af4199
    :END:
...
** UnloadedSource
   :PROPERTIES:
   :CUSTOM_ID: h:72c2180e-97c4-4209-9f09-031069cb5cbe
   :END:
...
*** Attributes
    :PROPERTIES:
    :CUSTOM_ID: h:3b58b48d-4d73-45c1-9486-3f6b8eb80d59
    :END:
...
** Thespian_StatusReq
   :PROPERTIES:
   :CUSTOM_ID: h:6428fa90-8749-4777-a0b1-752ec5eb1650
   :END:
   ...
   [[#h:704cb0e0-30c0-4e30-82cb-52718839704f][Thespian_SystemStatus]] or a [[#h:1a0b5d02-e4b6-4c8c-9687-6e5f939d3827][Thespian_ActorStatus]]
   message, depending on whether the ~Thespian_StatusReq~ was sent to
   an Actor or the ActorSystem.

*** Attributes
    :PROPERTIES:
    :CUSTOM_ID: h:02212902-4a42-4f1e-ae6a-59464043ff50
    :END:
   The ~Thespian_StatusReq~ object has no attributes.

** Thespian_SystemStatus
   :PROPERTIES:
   :CUSTOM_ID: h:704cb0e0-30c0-4e30-82cb-52718839704f
   :END:
...
** Thespian_ActorStatus
   :PROPERTIES:
   :CUSTOM_ID: h:1a0b5d02-e4b6-4c8c-9687-6e5f939d3827
   :END:
...
* Patterns and Helpers
  :PROPERTIES:
  :CUSTOM_ID: h:d4e592db-8bab-45bd-9643-e952510bd7dc
  :END:
...
** Actor Troupe Support
   :PROPERTIES:
   :CUSTOM_ID: h:c796bc0d-a150-4fb9-8918-58f470813175
   :END:

The use of [[#h:19cf92bf-a6ae-492c-844c-b0831c108a3a][Actor Troupes]] is supported by importing the
...
other actors to complete the work (or awaiting [[#h:9cc1acd4-7f35-44ac-94fc-0326dc87a7a5][WakeupMessages]]) must
...
** Transient Actors
   :PROPERTIES:
   :CUSTOM_ID: h:99783a4a-183f-4b69-8910-014d01edbf1c
   :END:
...
* ActorSystem Implementations
  :PROPERTIES:
  :CUSTOM_ID: h:2a5fa63d-e6eb-43b9-bea8-47223b27544e
  :END:
...
An argument may be passed to the [[#h:4adf735c-f237-4a8e-98db-ec52567353ac][ActorSystem]] constructor to specify
...
[[#h:924dc0fe-c15b-491e-a6d1-8b88683d4c0d][simpleSystemBase]] ActorSystem will be started.
...
** Common Capabilities
   :PROPERTIES:
   :CUSTOM_ID: h:2a4bcad4-9fe0-4399-86d4-4bbf0ba0acb7
   :END:

As described in [[#h:a17e6c70-5592-4d06-b818-bd25350c4c53][ActorSystem Capabilities]] each ActorSystem has a set of
capabilities that describe that ActorSystem and which can be audited
by the Actor's [[#h:0e9f4a6a-3083-40fa-a75b-ced37d70eef0][actorSystemCapabilityCheck]] method to determine if the
Actor is compatible with the ActorSystem.  Many capabilities can be
set when the ActorSystem is started (see [[#h:4adf735c-f237-4a8e-98db-ec52567353ac][ActorSystem]]), or updated at
run-time (see [[#h:1dc4362f-78dd-4adf-833c-d7bebda07ef8][updateCapability]] for either the Actor or the ActorSystem
...
ActorSystems:
  ...
  * *AllowRemoteActorSources* :: This capability specifies whether or
       ...
       ActorSystems as described in the [[#h:955ec990-a267-4d08-8f4d-5f980c777173][Actor Code Distribution]]
...
** simpleSystemBase
   :PROPERTIES:
   :CUSTOM_ID: h:924dc0fe-c15b-491e-a6d1-8b88683d4c0d
   :END:
  ...
  Testing and other very simplistic Actor environments:
    ...
    * It is possible for an Actor to modify the caller's version of
      the message (see [[#h:23ac66d7-ba55-40dc-ade8-a71e51c7a404][Message Mutability]]).
    * The [[#h:0e9f4a6a-3083-40fa-a75b-ced37d70eef0][actorSystemCapabilityCheck]] is not called for any Actors: all
      actors are created in the current ActorSystem regardless of
      their capability requirements.
    * No support for [[#h:461f4dc3-4bd6-46fe-a33e-2ad2a8d82d53][Multiple Systems]] (e.g. Conventions)
  ...
  There is one exception to the equilibrium state: pending [[#h:b2b4b63a-c256-4793-8591-1ce8dbd87131][wakeupAfter]]
  ...
  The simpleSystemBase uses the following [[#h:a17e6c70-5592-4d06-b818-bd25350c4c53][ActorSystem Capabilities]]:

  * *Thespian ActorSystem Name* :: /read-only/ "simpleSystemBase"

** multiprocQueueBase
   :PROPERTIES:
   :CUSTOM_ID: h:59ea5ca7-a167-4d51-bd1b-78119eab6df6
   :END:
...
in a Convention as described in [[#h:461f4dc3-4bd6-46fe-a33e-2ad2a8d82d53][Multiple Systems]].

The multiprocQueueBase uses the following [[#h:a17e6c70-5592-4d06-b818-bd25350c4c53][ActorSystem Capabilities]]:
...
** multiprocTCPBase
   :PROPERTIES:
   :CUSTOM_ID: h:9d33a877-b4f0-4012-9510-442d81b0837c
   :END:
...
** multiprocUDPBase
   :PROPERTIES:
   :CUSTOM_ID: h:25cfa213-13a6-4265-8828-86ffffed0e12
   :END:
...
The multiprocUDPBase uses the following [[#h:a17e6c70-5592-4d06-b818-bd25350c4c53][ActorSystem Capabilities]]:
  ...
  * *Convention Address.IPv4* :: the IPv4 address of the convention
    ...
    [[#h:9d33a877-b4f0-4012-9510-442d81b0837c][multiprocTCPBase]] for more details.
...
* Deploying Actor-based Projects
  :PROPERTIES:
  :CUSTOM_ID: h:23bdc6e2-a5c4-4228-a75c-fb213f537732
  :END:
...
** Overall Security Considerations
   :PROPERTIES:
   :CUSTOM_ID: h:7e109f00-76ff-49a1-b307-2166154c3921
   :END:
  ...
  * *Actor Injection* :: the use of the Source Authority (see
       [[#h:5ae05479-5a6d-4f01-bd7d-c4f544f7b98a][registerSourceAuthority]]) and associated sourceHash values
...
*** Security Scenarios
    :PROPERTIES:
    :CUSTOM_ID: h:fcabc7dd-327f-47cf-bcb7-5dd4d202ebdc
    :END:
