...
#+end_src
  ...
  [[*Other Actor Systems][Other Actor Systems]]) via ~ActorSystemConventionUpdate~ messages.
...
#+end_src
   ...
   handler for the current Actor System as described in the [[*Security Considerations][Security Considerations]] section of the [[*loadActorSource][loadActorSource]] Actor System API
...
#+end_src
   ...
   describe in [[*Named Actors][Named Actors]], this name allows the Actor to be uniquely
...
**** Multi-System Source Authorization
  ...
  Different Actor Systems in a [[*Multiple Systems][Multiple Systems]] configuration can each
...
ActorSystems:
  ...
  * *AllowRemoteActorSources* :: This capability specifies whether or
       ...
       Actor Systems as described in the [[*Actor Code Distribution][Actor Code Distribution]]
