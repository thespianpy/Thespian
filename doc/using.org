...
#+LATEX_HEADER: \docrev{2.19}{2017 Dec 01}
...
[[#hH-7d2b4986-95d3-4460-9d19-ea0dcdb34fca][ActorSystem API]] section.
...
[[#hH-f71b7bfa-c57b-4716-a2c7-ad83a2ed3582][ActorSystem]], and the known system bases are describe in [[#hH-2a5fa63d-e6eb-43b9-bea8-47223b27544e][ActorSystem Implementations]].
...
A Top-Level Actor is created via the [[#hH-a565af1b-aabb-4336-a51d-7505c072c319][ActorSystem.createActor]] call:
...
ActorSystem's [[#hH-8e52624b-cda1-4218-bc9f-693cf06b0758][ask]]() or [[#hH-a5dcf9d2-7bda-43c7-ab44-86265992e972][tell]]() methods to communicate with the created
Actor.
...
created Actor (using the current Actor's [[#hH-28cb6d46-fa93-4efd-bc83-88bbbd50df66][send]]() method).
...
described in [[#hH-5af075c1-73b1-4f7c-8515-e55ed96c03a9][Dead Letter Handling]].
...
** Actor Code Distribution
  ...
  The [[director.org][Thespian Director]] document describes the Director utility and
...
** Thespian Director
  ...
  See the [[director.org][Thespian Director]] document for more information on the Director.
...
ActorSystems:
  ...
  * *AllowRemoteActorSources* :: This capability specifies whether or
       ...
       ActorSystems as described in the [[#hH-955ec990-a267-4d08-8f4d-5f980c777173][Actor Code Distribution]]
...
The multiprocUDPBase uses the following [[#hH-a17e6c70-5592-4d06-b818-bd25350c4c53][ActorSystem Capabilities]]:
  ...
  * *Convention Address.IPv4* :: the IPv4 address of the convention
    ...
    [[#hH-9d33a877-b4f0-4012-9510-442d81b0837c][multiprocTCPBase]] for more details.
...
* Deploying Actor-based Projects
  ...
  * Distribute Thespian and a Source Authority via os-specific
  ...
  sources can be running simultaneously).  The [[director.org][Thespian Director]]
